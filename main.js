...
const PROJECTS = [
  {
    ...
    stack: ['Python','Machine Learning','Web Development','Video Processing','Neural Networks'],
  ...
  },
  {
    ...
    stack: ['Desktop Development','Database Management','UI Design','Workflow Automation'],
